...
type ConfigurationInterface interface {
	...
	Apply(ctx context.Context, configuration *configurationv1alpha1.ConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Configuration, err error)
...
// Apply takes the given apply declarative configuration, applies it and returns the applied configuration.
func (c *configurations) Apply(ctx context.Context, configuration *configurationv1alpha1.ConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Configuration, err error) {
	if configuration == nil {
		return nil, fmt.Errorf("configuration provided to Apply must not be nil")
	}
	...
	name := configuration.Name
	if name == nil {
		return nil, fmt.Errorf("configuration.Name must be provided to Apply")
	}
	result = &v1alpha1.Configuration{}
