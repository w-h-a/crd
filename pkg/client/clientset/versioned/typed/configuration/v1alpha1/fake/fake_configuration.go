...
func (c *FakeConfigurations) Apply(ctx context.Context, configuration *configurationv1alpha1.ConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Configuration, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(configurationsResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.Configuration{})
