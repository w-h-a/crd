...
func (c *FakeEventSources) Apply(ctx context.Context, eventSource *eventingv1alpha1.EventSourceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.EventSource, err error) {
	if eventSource == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(eventsourcesResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.EventSource{})
